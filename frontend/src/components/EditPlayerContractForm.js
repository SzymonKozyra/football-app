...
const EditPlayerContractForm = () => {
    ...
    const handleEditSubmit = (e) => {
        ...
        axios
            .put(`http://localhost:8080/api/player-contracts/${selectedContract.id}`, updatedContract, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then(() => {
                                    ...
                                    <Card className="mb-3 shadow-sm">
                                        ...
                                        >
                                            <div>
                                                ...
                                                <br />
                                                <strong>Salary:</strong> {contract.salary || 'Not specified'}
                                                <br />
